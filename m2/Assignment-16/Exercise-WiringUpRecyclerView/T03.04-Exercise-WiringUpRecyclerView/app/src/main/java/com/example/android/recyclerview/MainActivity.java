...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView mNumnbersList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumnbersList = (RecyclerView) findViewById(R.id.rv_numbers);
        ...
        mNumnbersList.setLayoutManager(layoutManager);
        mNumnbersList.setHasFixedSize(true);
